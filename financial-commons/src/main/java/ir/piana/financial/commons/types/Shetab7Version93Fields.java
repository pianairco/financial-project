...
public enum Shetab7Version93Fields implements ISOFieldType {
    ...
    B12_DATE_TIME_LOCAL_TRANSACTION(12, new IFB_NUMERIC(12), new IFA_NUMERIC(12), "date-time-local-transaction"),
//    B13_DATE_LOCAL_TRANSACTION(13, new IFB_NUMERIC(4), new IFA_NUMERIC(4), "date-local-transaction"),
    ...
    B15_DATE_SETTLEMENT(15, new IFB_NUMERIC(6), new IFA_NUMERIC(6), "date-settlement"),
...
//    B18_MERCHANT_CATEGORY_CODE(18, new IFB_NUMERIC(4), new IFA_NUMERIC(4), "merchant-category-code", "business-type"),
    ...
    B22_POINT_OF_SERVICE_ENTRY_MODE(22, new IF_CHAR(12), new IF_CHAR(12), "point-of-service-entry-mode"),
    B24_FUNCTION_CODE(24, new IFB_NUMERIC(3), new IFA_NUMERIC(3), "function-code"),
    B25_POSCC(25, new IFB_NUMERIC(4), new IFA_NUMERIC(4), "point-of-service-condition-code"),
    B26_POSPCC(26, new IFB_NUMERIC(4), new IFA_NUMERIC(4), "point-of-service-pin-capture-code"),
    B30_ORIGINAL_TRANSACTION_AMOUNT(30, new IFB_NUMERIC(24, false), new IFA_NUMERIC(24), "original-transaction-amount"),
    ...
    B39_RESPONSE_CODE(39, new IF_CHAR(3), new IF_CHAR(3), "response-code"),
    ...
    B43_CARD_ACCEPTOR_NAME_LOCATION(43, new IFB_LLCHAR( 99), new IFA_LLCHAR(99), "card-acceptor-name-location"),
    ...
    B53_SECURITY_RELATED_CONTROL_INFORMATION(53, new IFB_LLBINARY(48), new IFA_LLABINARY(48), "security-related-control-information"),
    ...
    B56_ORIGINAL_TRANSACTION_INFO(56, new IFB_LLNUM(35), new IFA_LLNUM(35), false, "original-transaction-info"),
    ...
    B93_REPLACEMENT_AMOUNT(93, new IFB_LLNUM(11), new IFA_LLNUM(11), "destination-identification-code"),
    B94_REPLACEMENT_AMOUNT(94, new IFB_LLNUM(11), new IFA_LLNUM(11), "source-identification-code"),
    B95_REPLACEMENT_AMOUNT(95, new IF_CHAR(42), new IF_CHAR(42), "replacement-amount"),
    B96_MESSAGE_SECURITY_CODE(96, new IFB_LLLBINARY(999), new IFA_LLLBINARY(999), "message-security-code"),
    B97_AMOUNT_NET_RECONCILIATION(97, new IFB_AMOUNT(16, true), new IFA_AMOUNT(16), "amount-net-reconciliation"),
    B99_SETTLEMENT_INSTITUTION_IDENTIFICATION_CODE(99, new IFB_LLCHAR(11), new IFA_LLCHAR(11), "settlement-institution-identification-code"),
    ...
    B109_ACCOUNT_IDENTIFICATION_1(109, new IFB_LLCHAR(84), new IFA_LLCHAR(84), "account-identification-1"),
    B110_ACCOUNT_IDENTIFICATION_1(110, new IFB_LLCHAR(84), new IFA_LLCHAR(84), "account-identification-1"),
    ...
    Shetab7Version93Fields(int bitNumber, ISOFieldPackager isoBinaryFieldPackager, ISOFieldPackager isoAsciiFieldPackager, boolean shetabUsed, String... bitName) {
    ...
    Shetab7Version93Fields(int bitNumber, ISOFieldPackager isoBinaryFieldPackager, ISOFieldPackager isoAsciiFieldPackager, String... bitName) {
        this.bitNumber = bitNumber;
        this.isoBinaryFieldPackager = isoBinaryFieldPackager;
        this.isoAsciiFieldPackager = isoAsciiFieldPackager;
    ...
    public static Shetab7Version93Fields fromBitNumber(int bitNumber) {
        for (Shetab7Version93Fields s : Shetab7Version93Fields.values()) {
    ...
    public static ISOBasePackager getIsoBinaryPackager() {
        if (isoBinaryPackager == null) {
            synchronized (Shetab7Version93Fields.class) {
                if (isoBinaryPackager == null) {
    ...
    public static ISOBasePackager getIsoAsciiPackager() {
