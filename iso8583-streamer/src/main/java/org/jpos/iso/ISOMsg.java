...
import org.jpos.iso.log.Loggeable;
import org.jpos.iso.packager.XMLPackager;
import org.jpos.iso.util.HexUtils;
...
public class ISOMsg extends ISOComponent
    ...
    protected byte[] lastCalculatedBytes;
    ...
    public void set(int fldno, String value) {
        ...
        ; //NOPMD: never happens for the given arguments of set methods
    }
     ...
     * @throws ISOException if this is an inner message
     */
    ...
    public void setLastCalculatedBytes(byte[] lastCalculatedBytes) {
        this.lastCalculatedBytes = lastCalculatedBytes;
    }

    public String hexString() {
        try {
            return hexString(false);
        } catch (ISOException e) {
            return "";
        }
    }

    public String hexString(boolean recalc) throws ISOException {
        if (recalc && getPackager() != null) {
            lastCalculatedBytes = pack();
        }
        return HexUtils.bytesToHex(lastCalculatedBytes);
    }
}
