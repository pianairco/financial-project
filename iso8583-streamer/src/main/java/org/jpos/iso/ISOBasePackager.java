...
public abstract class ISOBasePackager implements ISOPackager {
    ...
    public byte[] pack(ISOComponent m) throws ISOException {
        try {
            ...
            if (emitBitMap()) {   // The ISOComponent stores a single bitmap in field -1, which could be up to
     ...
     */
    protected static void fieldUnpackLogger(int fldno, ISOComponent c, ISOFieldPackager fld, boolean logFieldName) throws ISOException {
