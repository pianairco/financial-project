...
public class ISOTagBinaryFieldPackager extends ISOBinaryFieldPackager
{
     ...
     */
    public ISOTagBinaryFieldPackager(Prefixer tagPrefixer, Padder padder,
     ...
     * @param prefixer The type of length prefixer used to encode this field.
     */
    public ISOTagBinaryFieldPackager(int maxLength, String description, Prefixer tagPrefixer,
